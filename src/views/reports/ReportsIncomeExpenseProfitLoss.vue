...
import ReportsIncomeExpenseProfitLoss from "@/components/reports/ReportsIncomeExpenseProfitLoss.vue";
</script>
...
<template>
  <ReportLayout title="Profit & Loss" :extra_params="extra_params">
    <template #settings>
    ...
    <div class="bg-white shadow mt-4 prose max-w-none">
      <ReportsIncomeExpenseProfitLoss v-if="store.props.currency && !store.processing" />
    </div>
  </ReportLayout>
</template>
