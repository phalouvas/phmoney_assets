...
export default {
    ...
    methods: {
        ...
        calculate_tax() {
            ...
            let bill_taxtable = this.store.props.taxtables.find(
        ...
        <div class="p-3 border">
            <div class="flex flex-wrap gap-2">
                ...
                <div>
                    ...
                    <select id="taxable" name="taxable" v-model="form.b_taxable"
                        class="border-gray-300 focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50 rounded-md shadow-sm"
                ...
                <div>
                    ...
                    <select id="taxincluded" name="taxincluded" v-model="form.b_taxincluded"
                        class="border-gray-300 focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50 rounded-md shadow-sm">
                        <option :value="false">No</option>
                        <option :value="true">Yes</option>
                    </select>
                ...
                <div>
                    ...
                    <select id="taxtable" name="taxtable" v-model="form.b_taxtable"
                        class="border-gray-300 focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50 rounded-md shadow-sm"
                        @change="calculate_tax">
